          ...
          <div className="row">
            ...
            <div className="col-xl-4 col-md-4 mb-30">
              <div className="single-cta">
                ...
                <div >
                  <h4>Call us</h4>
                  <a className="text-decoration-none" href="tel:+201095617424">+201095617424</a>
                </div>
              </div>
            </div>
            <div className="col-xl-4 col-md-4 mb-30">
              <div className="single-cta">
                ...
                <div >
                  <h4>Mail us</h4>
                  <a className="text-decoration-none " href="mailto:saeed96mohamed@gmail.com" target="_blank">saeed96mohamed@gmail.com</a>
                </div>
              </div>
            </div>
          </div>
